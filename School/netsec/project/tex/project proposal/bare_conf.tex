...
\subsection{Task 1. Capture and analyze packet data for a SSBM game via NetPlay -- Austin and Philip (3 weeks)}
...
\subsection{Task 2. Design and test out cheating on SSBM via spoofing packets -- Austin (4 weeks)}
Using what we learned from task 1, we will design and test out methods of cheating in SSBM games by spoofing data.

\subsection{Task 3. Design and test attacks on victim PC via NetPlay -- Philip (4 weeks)}
...
\subsection{Task 4. Propose solutions to vulnerabilities found -- Austin and Philip (3 weeks)}
